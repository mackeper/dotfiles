---
description: "Use when: exploring user intent and shaping requirements/design before any implementation work."
---
...
Every project goes through this process. A to-do list, a single-function
...
5. **Write design doc** — save to `./docs/<topic>/YYYY-MM-DD-<topic>-design-spec.md`
...
- Use *spec-writer* to write  the validated design (spec) to `./docs/<topic>/YYYY-MM-DD-<topic>-design-spec.md`
