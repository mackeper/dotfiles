"Marcus Östling neo vimrc
    " :PlugInstall 
    " :CocInstall coc-omnisharp coc-json coc-sql coc-eslint coc-html coc-db
...
call plug#begin()
    ...
    " p/ython3 install.py --clang-completer
    " or
    " python3 install.py --all
    " Plug 'valloric/youcompleteme'

    " Plug 'Shougo/deoplete.nvim', { 'do': ':UpdateRemotePlugins' }
    " Plug 'zchee/deoplete-jedi'              " ppython completer
...
"" Mapping
    ...
    noremap <C-m> :Mru<CR>
    " FZF
    noremap <C-p>  :FZF --bind ctrl-p:abort<CR>
...
"" Colors
    ...
    colorscheme wal
    highlight CursorLineNr cterm=NONE ctermbg=NONE ctermfg=4* gui=NONE guibg=NONE guifg=NONE
...
"" Use deoplete.
    ...
    "let g:python3_host_prog = "C:/Users/macke/AppData/Local/Microsoft/WindowsApps"
